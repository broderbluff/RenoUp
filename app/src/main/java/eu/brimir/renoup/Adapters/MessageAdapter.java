...
public class MessageAdapter extends ArrayAdapter<ParseObject>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.timeLabel.setText(convertedDate + " - " +message.getString(ParseConstants.KEY_SENDER_NAME));
        ...
        if(message.getString(ParseConstants.KEY_FILE_TYPE).equals(ParseConstants.TYPE_IMAGE)){
            ...
            holder.nameLabel.setText(message.getString(ParseConstants.KEY_FELKOD) + " - " +message.getString(ParseConstants.KEY_ADDRESS));
